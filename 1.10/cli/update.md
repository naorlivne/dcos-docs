...
**Important:** If you downloaded the CLI from PyPI or from the DC/OS UI version 1.7 or earlier, you must completely [uninstall](/docs/1.10/cli/uninstall/) the CLI. You cannot upgrade.
