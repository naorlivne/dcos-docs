...
You can create a DC/OS cluster for Amazon Web Services (AWS) using the <a href="https://downloads.dcos.io/dcos/stable/1.9.2/aws.html" target="_blank">DC/OS templates for AWS CloudFormation</a>.
